...
struct ResticIntegrationTests {
    ...
    func cancellation() async throws {
        ...
        // Enough data that the backup is still running when we cancel it.
        ...
        do {
            ...
            // A very fast machine may finish before the cancel lands; that is not
            // a failure of the cancellation path itself.
